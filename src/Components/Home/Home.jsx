...
const Home = () => {
    ...
    return (
        <HomeStyled flexDir="column" justifyContent="space-between" alignItems="center" h="88vh" p="40px 20px">
            ...
            <Box h=""></Box>
            <Text color={color} fontSize="1.5rem" fontWeight="bold" textAlign="left">Hi, I'm <Text as="span" color={colors.ctaColor}>Nikolai</Text> <br/> Front end Developer </Text>
            {/* <Moon height="300px" width="300px"/> */}
            <WordBall height="300px" width="100%" />
